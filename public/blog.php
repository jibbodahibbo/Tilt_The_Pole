...
<a href=" <?php echo "https://www.linkedin.com/shareArticle?mini=true&url=" . WWW_ROOT . "/blogpost.php?id=" . h(u($blog_post['id'])) . "&title=TITLE&summary=&source=" ; ?>">Share on LinkedIn</a>
<!--- Social Share END-->
<br>
